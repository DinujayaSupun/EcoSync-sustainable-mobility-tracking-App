                        ...
                        <div key={challengeId} className="rounded-2xl border border-emerald-100 bg-white p-5 shadow-sm">
                          ...
                          {participation.evidence?.length > 0 && (
                            <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
                              <p className="mb-3 font-semibold text-slate-900">Evidence history</p>
                              <div className="space-y-3">
                                {participation.evidence.map((item, idx) => (
                                  <div key={`${item.uploadedAt || idx}-${item.name || idx}`} className="rounded-2xl border border-slate-200 bg-white p-3">
                                    ...
                                    {item.url ? (
                                      <a href={item.url} target="_blank" rel="noreferrer" className="mt-2 inline-flex text-sm font-semibold text-blue-600 hover:text-blue-800">
                                        View proof
                                      </a>
                                    ) : null}
                                  </div>
