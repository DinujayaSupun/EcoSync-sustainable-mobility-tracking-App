              ...
              {recentTrips.length > 0 ? (
                recentTrips.map((trip) => {
                  ...
                  return (
                    <div
                      key={trip._id}
                      className={`flex items-center gap-3 p-3 ${style.bg} rounded-lg border-l-4 ${style.border}`}
                    >
                      <div
                        className={`w-2 h-2 ${style.dot} rounded-full animate-pulse`}
                      ></div>
                      <div className="flex-1">
                        <p className="text-sm text-gray-700">
                          <strong>{trip.faculty}:</strong> Saved {trip.co2Saved}
                          kg via{" "}
                          {trip.transportMode.charAt(0).toUpperCase() +
                            trip.transportMode.slice(1)}
                        </p>
                      </div>
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500">
                          Mode: {ch.transportMode} | Target: {ch.emissionTarget}{" "}
                          | Duration: {ch.durationDays}d | Reward:{" "}
                          {ch.rewardPoints}
                        </p>
                      </div>
