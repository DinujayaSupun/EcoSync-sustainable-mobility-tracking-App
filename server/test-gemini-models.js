...
// List of common Gemini model names to test (ordered by likelihood to work)
  ...
  try {
    ...
    if (workingModels.length > 0) {
      ...
      workingModels.forEach((model, index) => {
        ...
        console.log(
          `      Response: "${model.response.substring(0, 50)}..."\n`,
        );
      });
      ...
      console.log(
        `   const model = genAI.getGenerativeModel({ model: "${workingModels[0].name}" });\n`,
      );
      console.log(
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n",
      );
