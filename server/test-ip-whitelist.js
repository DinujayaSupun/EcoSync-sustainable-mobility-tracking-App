  ...
  try {
    ...
    if (urlMatch) {
      ...
      try {
        ...
        console.log(
          "   → Your cluster might be deleted, paused, or the URL is incorrect\n",
        );
        return;
      }
      ...
      try {
        ...
        if (
          connError.message.includes("IP") ||
          connError.message.includes("whitelist")
        ) {
          ...
          connError.message.includes("credentials")
        ) {
