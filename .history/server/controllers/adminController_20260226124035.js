...
Keep it professional and suitable for presentation to university administrators.`;
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a sustainability analytics expert specializing in campus transportation and environmental impact analysis.",
        },
        {
          role: "user",
          content: prompt,
    ...
    if (error.response) {
      ...
      if (error.response.status === 429) {
        userMessage =
          "OpenAI API quota exceeded. Please check your billing at https://platform.openai.com/account/billing or contact your administrator.";
