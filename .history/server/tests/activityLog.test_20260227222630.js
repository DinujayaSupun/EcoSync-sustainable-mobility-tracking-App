...
const { logActivity, createActivityLog } = require('../middleware/activityLogger');
...
describe('Activity Logger Tests', () => {
  ...
  describe('Activity Statistics', () => {
    beforeEach(async () => {
      const logs = [
        { admin: adminUser._id, action: 'UPDATE', targetType: 'User', targetId: testUser._id },
        { admin: adminUser._id, action: 'UPDATE', targetType: 'User', targetId: testUser._id },
        { admin: adminUser._id, action: 'DELETE', targetType: 'User', targetId: testUser._id },
