...
**Example URL**: `PUT /api/admin/users/65f1234567890abcdef12345`
...
- `email`: Email address (checks for duplicates)
...
15. **Delete User** (Use with caution!)
